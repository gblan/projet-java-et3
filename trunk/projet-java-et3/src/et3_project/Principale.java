...
public class Principale extends JFrame {
	...
	public Principale(String title, int width, int height) {
		...
		/*
		 * ArrayList<Case> ligne1 = new ArrayList<Case>(); ArrayList<Case>
		 * ligne2 = new ArrayList<Case>(); ArrayList<Case> ligne3 = new
		 * ArrayList<Case>(); Case c1 = new Case(CaseEnum.DISPONIBLE, 80, 150);
		 * Case c2 = new Case(CaseEnum.DISPONIBLE, 120, 150); Case c12 = new
		 * Case(CaseEnum.DISPONIBLE, 40, 150); Case c22 = new
		 * Case(CaseEnum.DISPONIBLE, 0, 150); Case c111 = new
		 * Case(CaseEnum.DISPONIBLE, 160, 150); Case c222 = new
		 * Case(CaseEnum.DISPONIBLE, 200, 150); Case c122 = new
		 * Case(CaseEnum.DISPONIBLE, 240, 150); ligne1.add(c1); ligne1.add(c2);
		 * ligne1.add(c12); ligne1.add(c22); ligne1.add(c111); ligne1.add(c222);
		 * ligne1.add(c122); grille.add(ligne1); Case c31 = new
		 * Case(CaseEnum.DISPONIBLE, 20, 185); Case c3 = new
		 * Case(CaseEnum.DISPONIBLE, 60, 185); Case c4 = new
		 * Case(CaseEnum.DISPONIBLE, 100, 185); Case c5 = new
		 * Case(CaseEnum.DISPONIBLE, 140, 185); Case c55 = new
		 * Case(CaseEnum.DISPONIBLE, 220, 185); Case c6 = new
		 * Case(CaseEnum.DISPONIBLE, 180, 185); Case c66 = new
		 * Case(CaseEnum.DISPONIBLE, 260, 185); ligne2.add(c3); ligne2.add(c4);
		 * ligne2.add(c5); ligne2.add(c6); ligne2.add(c31); ligne2.add(c55);
		 * ligne2.add(c66); grille.add(ligne2); Case c7 = new
		 * Case(CaseEnum.DISPONIBLE, 60, 395); Case c8 = new
		 * Case(CaseEnum.DISPONIBLE, 100, 395); ligne3.add(c7); ligne3.add(c8);
		 * grille.add(ligne3);
		 */
